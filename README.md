...
This directory stores all data files and results.
...
Download the processed data folder **[`processed_data`](https://www.dropbox.com/scl/fo/8umsd9el3lzhdg0gbmw4v/AHqV0zYwV1J1iSDTJdXUg04?rlkey=pnjknapnftl4tl6kybk69acfj&st=prze81jo&dl=0)** and place it in `Data_Results/Data/`. This folder contains the processed datasets generated from the raw data and serves as the input for FuDiCo.


## Precomputed FuDiCo Data (Recommended)
...
To generate the precomputed data, run:
